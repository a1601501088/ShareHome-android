...
public class Encrypt3DES {
    ...
    public static void main(String[] args) {
       /* try {
            String test = "asDDF554$%123456";

            *//*System.out.println("加密前的字符：a1acqso2ht" + test);
            String encrypt = Encrypt3DES.getInstance().encrypt(test);
            System.out.println("加密后的字符：" + encrypt);*//*
            System.out.println("解密后的字符：" + Encrypt3DES.getInstance().decrypt("9b87f1360a1358af4834eb6ab4a01b15"));
